...
El código desarrollado se encuentra en el siguiente repositorio de Github@repo. Donde se pueden consultar las contribuciones de cada miembro, en la programación (`www/`, `server/`), planeacion (`docs/diagramas`, `docs/interfaces`, `docs/planning.md`, ...) y redaccion de la memoria (`memoria/`).
