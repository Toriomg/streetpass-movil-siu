...
## 🟢 FASE 1: Cimientos y Arquitectura (Semana 1)
...
- [ ] ?? **Mock Data Engine:** Crear un generador de "personas cercanas" aleatorias con: Nombre, Foto, Gustos Comunes, Teléfono y Distancia.
...
- [ ] **Componentes del Reloj:**
  ...
  - [ ] Pantalla `Preferencias` (Para explicar el ).
- [ ] **Interfaz de Usuario PC (Modo Casa):**
  - [ ] Animación de `FaceID` para el desbloqueo inicial.
...
## 🟡 FASE 3: Captura y Lógica de Gestos (El "Core" Ubicuo)
...
## 🟠 FASE 4: Funcionalidades Avanzadas (Diferenciación)
...
## ⚪ FASE 6: Documentación y Entrega (P2/P3)
